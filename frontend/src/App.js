    ...
    <MuiThemeProvider theme={theme}>
      <Container>
        ...
        <Box mt={6} style={{ textAlign: "center" }}>
          <Typography variant="overline" paragraph style={{paddingLeft: "10em", paddingRight: "10em"}}>This tool has been developed with a <Link href="https://www.alprofoundation.org/project/communicating-the-environmental-impact-of-plant-based-recipes/" target="_blank">research grant</Link> from the <Link href="https://www.alprofoundation.org/" target="_blank">Alpro Foundation</Link> and by <Link href="https://www.ukri.org/councils/research-england/" target="_blank">Research England</Link> via The University of Sheffield's Internal Knowledge Exchange Scheme</Typography>
